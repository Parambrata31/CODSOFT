...
genre_list=['action','adult','adventure','animation','biography','comedy','crime','documentary','family','fantasy','game-show','history','horror','music','musical','mystery','news','reality-tv','romance','sci-fi','short','sport','talk-show','thrillrer','war','western']
...
print("Model evaluation results and matrics have been saved to 'model_evaluation.txt'.")          
